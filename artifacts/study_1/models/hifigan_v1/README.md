...
This directory contains the Study 1 evidence package for HiFi-GAN V1. One model was trained from random initialization through two pre-registered compute gates, and its selected durable state was evaluated in three complete adaptive-benchmark executions.
...
| Generator parameters | 13,936,130 |
...
|---:|---:|---:|---:|---:|
| 42 | 3.317268 | 0.974800 | 0.270400 | 0.103254 |
| 43 | 3.316937 | 0.974800 | 0.270400 | 0.156754 |
| 44 | 3.316905 | 0.974800 | 0.270400 | 0.099213 |
| Mean | 3.317037 | 0.974800 | 0.270400 | 0.119740 |

Gate 1 evaluated the step-120,000 state and produced PESQ 3.1706. Gate 2 improved seed-42 PESQ by 0.1467, but the final value remained 0.0827 below the locked 3.4 target when the 500,000-step batch-16-equivalent ceiling was reached. The accepted classification is therefore a partial reproduction at the registered compute ceiling.

## Released-Checkpoint Reference

The legacy author-checkpoint summary reports three-seed PESQ 3.6338 on the same 525-utterance B200 FP32 evaluation surface. The project-trained mean is 91.3% of that anchor. Only PESQ is used for this cross-harness comparison; the legacy STOI and mel-error values were produced by an earlier metric protocol. The author checkpoint is not a project-trained execution and is excluded from experiments.csv.
