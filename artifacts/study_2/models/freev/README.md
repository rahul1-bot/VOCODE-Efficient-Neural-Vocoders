...
This directory contains the Study 2 intervention results for FreeV under the common LJSpeech evaluation design.

## Results

| Variant | Lane | PESQ | Δ PESQ | Speedup | Size ratio | State |
|---|---|---|---|---|---|---|
| baseline_b200 | b200 | 3.379005 | +0.000000 | 1.000× | 1.000 | denominator |
| baseline_cpu | cpu | 3.379689 | +0.000000 | 1.000× | 1.000 | denominator |
| int8_dynamic | cpu | 3.256816 | -0.122873 | 1.303× | 0.418 | harmful |
| int8_weight_only | b200 | 3.377513 | -0.001492 | 0.851× | 0.421 | inconclusive |
| pruned_50 | b200 | 2.099889 | -1.279115 | 0.931× | 1.000 | harmful |
| torch_compile | b200 | 3.379004 | -0.000000 | 1.070× | 1.000 | inconclusive |
| torch_compile_overhead | b200 | 3.379004 | -0.000000 | 0.411× | 1.000 | harmful |

## Excluded Executions

| Variant | Category | Attempts | Reason |
|---|---|---|---|
| pruned_50_recovered | invalid_complete_group | 3 | The checkpoint declared by the evaluation recipe does not match the retained recovery state, so the evaluated state cannot be reconstructed. |
